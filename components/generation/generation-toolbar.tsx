        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <button
              ...
              className={cn(
                pillCls,
                'text-primary dark:text-primary animate-[pulse_3s_ease-in-out_infinite]',
                'bg-primary/5 dark:bg-primary/10 hover:bg-primary/10 dark:hover:bg-primary/20 border-primary/20 shadow-sm transition-all hover:scale-[1.02]',
              )}
            >
