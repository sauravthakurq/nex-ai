...
export function Roundtable({
  ...
  const setIsDockExpanded = (val: boolean) => setSnapPoint(val ? 25 : 0);
  ...
  if (isPresenting) {
    return (
      <div className="h-0 w-full relative z-10 overflow-visible">
        ...
        <div
          className={cn(
            'fixed bottom-0 left-0 z-[40] pointer-events-none flex items-center justify-center transition-all duration-150',
        ...
        <div
          className="fixed bottom-14 left-0 z-[50] flex flex-col items-center justify-center gap-3 pointer-events-none transition-[right] duration-150"
          style={{ right: chatCollapsed === false ? (chatAreaWidth ?? 320) : 0 }}
        >
          {/* Input panel */}
          <AnimatePresence>
            {isInputOpen && (
              <motion.div
                ...
                className="w-[min(480px,calc(100vw-3rem))] pointer-events-auto hidden md:block"
              >
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isSendCooldown
                        ...
                        : 'bg-black text-white hover:text-white hover:bg-black text-white hover:text-white shadow-[0_4px_16px_rgba(147,51,234,0.3)]',
                    )}
                  >
                    {isSendCooldown ? (
              ...
              >
                <div className="flex items-center gap-4 bg-white/70 dark:bg-black/60 backdrop-blur-xl rounded-full px-5 py-3 shadow-[0_8px_32px_rgba(0,0,0,0.08)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-gray-200/60 dark:border-white/10">
                  ...
                  <div className="flex items-center gap-0.5 h-8">
                    <VoiceWaveformBars barClassName="bg-gradient-to-t from-gray-400 to-indigo-400" />
                  </div>
                  <span className="text-[11px] font-semibold tracking-wider text-black dark:text-gray-300 uppercase">
                  ...
                  >
                    <div className="relative w-12 h-12 rounded-full bg-gradient-to-br from-gray-600 to-indigo-700 shadow-[0_4px_20px_rgba(147,51,234,0.3)] flex items-center justify-center group-hover:scale-105 transition-transform duration-150 border border-white/20">
                      <Mic className="w-5 h-5 text-white" />
                    </div>
                    <div className="absolute inset-0 rounded-full border-2 border-gray-500 opacity-40 animate-[ping_2s_ease-in-out_infinite]" />
                  </button>
                </div>
              </motion.div>
            )}
        ...
        <div
          className="fixed bottom-5 z-[48] flex flex-col items-end gap-3 pointer-events-none transition-[right] duration-150"
              ...
              >
                ...
                >
                    ...
                    {((activeRole === 'agent' && speakingStudent) ||
                      ...
                      >
                        <div className="relative w-10 h-10 rounded-full flex items-center justify-center">
                          <div className="absolute inset-0 rounded-full border-2 border-blue-500 shadow-[0_0_6px_rgba(59,130,246,0.3)] transition-all duration-150" />
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          !asrEnabled
                            ...
                            : isVoiceOpen
                              ? 'bg-black text-white hover:text-white text-white'
                  ...
                  >
                    <div
                      className={cn(
                        'relative w-10 h-10 rounded-full transition-all duration-150 flex items-center justify-center',
                        ...
                        className={cn(
                          ...
                          isCueUser
                            ...
                            : activeRole === 'user' || isInputOpen
                              ? 'border-gray-500 shadow-[0_0_6px_rgba(0,0,0,0.3)]'
                              : 'border-gray-300/40 dark:border-white/20 group-hover:border-gray-400/50',
                        )}
                      />
                      <div className="w-8 h-8 rounded-full bg-gray-200 dark:bg-gray-800 overflow-hidden relative z-10 text-lg">
  ...
  return (
    <div
      className={cn(
        'w-full h-full min-h-0 flex flex-col relative z-10 transition-all duration-150',
    ...
    >
      ...
      <div className="flex-1 flex flex-col md:flex-row items-stretch min-h-0">
        ...
        <div className="flex-1 relative mx-3 my-2 md:mb-2 min-h-[120px] md:min-h-0">
            ...
            <AnimatePresence>
              {isInputOpen && (
                <motion.div
                  ...
                  className="absolute inset-x-6 bottom-4 z-20 hidden md:flex items-center justify-end"
                >
                  <div className="relative w-fit max-w-[85%] sm:max-w-[65%] min-w-[200px] sm:min-w-[300px] bg-white/90 dark:bg-gray-800/90 backdrop-blur-md p-2 pr-2 rounded-2xl rounded-br-none shadow-2xl border border-gray-200 dark:border-gray-700 flex items-end gap-2 ring-1 ring-gray-100/50 dark:ring-gray-800/50">
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        isSendCooldown
                          ...
                          : 'bg-black text-white hover:text-white hover:bg-black text-white hover:text-white dark:bg-gray-800 dark:hover:bg-black text-white hover:text-white shadow-gray-200 dark:shadow-gray-900/50',
                      )}
                    >
                      {isSendCooldown ? (
              ...
              {isVoiceOpen && (
                ...
                >
                  <div className="flex flex-col-reverse items-end gap-1 mr-[-10px] relative z-20">
                    <div className="flex items-center gap-0.5 h-8 px-2 py-1.5 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm">
                      <VoiceWaveformBars barClassName="bg-gradient-to-t from-gray-500 to-indigo-600 dark:from-gray-400 dark:to-gray-600" />
                    </div>
                    <motion.div
                      initial={{ opacity: 0, x: 10 }}
                      animate={{ opacity: 1, x: 0 }}
                      className="text-[10px] font-bold tracking-widest text-black dark:text-gray-400 uppercase bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm px-2 py-0.5 rounded-full shadow-sm border border-gray-100/50 dark:border-gray-800/50 mr-1"
                    >
                      {isProcessing ? t('roundtable.processing') : t('roundtable.listening')}
                    </motion.div>
                  </div>
                  ...
                  <div
                    ...
                    onClick={handleToggleVoice}
                  >
                    <div className="relative w-16 h-16 rounded-full bg-gradient-to-br from-gray-600 to-indigo-700 dark:from-gray-500 dark:to-gray-700 shadow-[0_4px_20px_rgba(147,51,234,0.3)] flex items-center justify-center z-20 group-hover:scale-105 transition-transform duration-150 border border-white/20 dark:border-white/10">
                      <Mic className="w-6 h-6 text-white" />
                    </div>
                    <div className="absolute inset-0 rounded-full border-2 border-gray-500 dark:border-gray-400 opacity-40 animate-[ping_2s_ease-in-out_infinite] z-10" />
                    ...
                    <div className="absolute inset-0 bg-black text-white hover:text-white dark:bg-gray-800 blur-2xl opacity-20 group-hover:opacity-40 transition-opacity z-0" />
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
                    ...
                    <div
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'bg-gray-400/[0.08] dark:bg-gray-800/[0.06]',
                      )}
                    />
                    ...
                    <motion.div
                      ...
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'border-gray-400/50 dark:border-gray-500/35',
                      )}
                    />
                    {/* Expanding ripple 2 */}
                    <motion.div
                      ...
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'border-gray-300/40 dark:border-gray-400/25',
                      )}
                    />
                    ...
                    <motion.button
                      ...
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'from-gray-400 to-gray-600 dark:from-gray-500 dark:to-gray-700 shadow-gray-400/30 dark:shadow-gray-600/20 hover:shadow-gray-400/40 dark:hover:shadow-gray-600/30',
                      )}
                    >
                      {asrEnabled ? (
                    ...
                    <div className="flex items-center justify-center gap-[3px] h-3">
                      {[0, 1, 2, 3, 2, 1, 0].map((intensity, i) => (
                        <motion.div
                          ...
                          className="w-[2.5px] h-full origin-center rounded-full bg-gray-400/60 dark:bg-gray-800/50"
                        />
                      ))}
                    </div>
                  )}
                  ...
                  <motion.span
                    ...
                    className={cn(
                      ...
                      asrEnabled
                        ...
                        : 'text-black/70 dark:text-gray-400/60',
                    )}
                  >
                    {t('roundtable.yourTurn')}
                  </motion.span>
        ...
        <div
          className={cn(
            'hidden shrink-0 flex-col overflow-x-visible items-stretch py-3 border-l border-gray-100/50 dark:border-gray-700/50 bg-gray-50/30 dark:bg-gray-900/30 overflow-visible transition-opacity duration-150',
            isPresenting && !controlsVisible && 'opacity-0 pointer-events-none',
          )}
        >
                    ...
                    >
                      ...
                      <HoverCard openDelay={300} closeDelay={100}>
                        <HoverCardTrigger asChild>
                          <div
                            className={cn(
                              'relative w-9 h-9 rounded-full transition-all duration-150 cursor-pointer',
                              isSpeaking
                          ...
                          >
                            <div
                              className={cn(
                                'absolute inset-0 rounded-full border-2 transition-all duration-150',
                                isSpeaking
                                  ? 'border-gray-500 dark:border-gray-400 shadow-[0_0_8px_rgba(0,0,0,0.4)]'
                            ...
                            {isThinkingAgent && (
                              <div className="absolute inset-0 rounded-full border-2 border-gray-400 border-t-transparent animate-spin z-20" />
                            )}
                          </div>
                        </HoverCardTrigger>
                        <HoverCardContent
          ...
          <div className="flex-1 flex items-center justify-center gap-3 px-2 min-h-0">
                  ...
                  <div className="flex items-center gap-[3px]">
                    {[0, 1, 2].map((i) => (
                      <motion.div
                        ...
                        className="w-[4px] h-[4px] rounded-full bg-gray-400 dark:bg-gray-400"
                      />
                    ))}
                  </div>
                </div>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      !asrEnabled
                        ...
                        : isVoiceOpen
                          ? 'bg-black text-white hover:text-white dark:bg-gray-800 border-black dark:border-gray-500 text-white shadow-gray-200 dark:shadow-gray-800'
                          : 'bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-400 dark:text-gray-500 hover:bg-gray-50 dark:hover:bg-gray-900/20 hover:text-black dark:hover:text-gray-400 hover:border-gray-200 dark:hover:border-gray-700',
                    )}
                  >
                    {asrEnabled ? (
            ...
            >
              <div
                className={cn(
                  'relative w-16 h-16 rounded-full transition-all duration-150 flex items-center justify-center',
                  activeRole === 'user' || isInputOpen || isCueUser
                    ? 'scale-105'
                ...
                <div
                  className={cn(
                    ...
                    isCueUser
                      ...
                      : activeRole === 'user' || isInputOpen
                        ? 'border-black dark:border-gray-400 shadow-[0_0_8px_rgba(0,0,0,0.3)]'
                        : 'border-white dark:border-gray-700 group-hover:border-gray-200 dark:group-hover:border-black',
                  )}
                />
