...
import { PanelRightClose, BookOpen, MessageSquare, ChevronLeft } from 'lucide-react';
...
export const ChatArea = forwardRef<ChatAreaRef, ChatAreaProps>(
  (
    ...
    return (
      <>
        {/* Backdrop for 10% space outside when not collapsed, allowing user to tap outside to close */}
        {!collapsed && (
          <div
            className="fixed inset-0 z-40 bg-black/10 dark:bg-black/20 backdrop-blur-[2px] transition-opacity cursor-pointer md:hidden"
