      ...
      {open && (
        ...
        >
          ...
          <div className="flex w-full overflow-x-auto snap-x snap-mandatory gap-4 px-4 md:flex-wrap md:justify-center md:items-stretch md:overflow-x-visible md:snap-none md:gap-5 scrollbar-hide py-2">
            {agents.map((agent, index) => {
              ...
              return (
                <motion.div
                  key={agent.id}
                  className="group relative shrink-0 snap-center mx-auto w-full max-w-[280px] min-h-[260px] md:w-[196px] md:max-w-none md:h-[290px] md:min-h-0"
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="relative flex size-full flex-col overflow-clip rounded-[14px] bg-white dark:bg-zinc-900">
                          ...
                          <div className="min-h-0 flex-1 overflow-y-auto scrollbar-hide overscroll-contain px-3.5 pt-1.5 pb-3">
                            <p className="text-left text-sm md:text-[10.5px] leading-[1.65] text-zinc-600 dark:text-zinc-400">
                              {agent.persona}
                            </p>
                          </div>
          ...
          >
            ...
            {allRevealed && (
              <motion.button
                className="w-full max-w-xs md:w-auto rounded-full bg-zinc-800 px-6 py-3 md:py-2 text-sm font-medium text-white transition-colors hover:bg-zinc-700 dark:bg-white/15 dark:hover:bg-white/25"
